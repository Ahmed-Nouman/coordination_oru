...
public class Task {
    ...
    public boolean equals(Object o) {
        ...
        Task task = (Task) o;
        return Double.compare(startTime, task.startTime) == 0 && priority == task.priority && Objects.equals(name, task.name) && Objects.deepEquals(poses, task.poses) && Objects.deepEquals(stoppageTimes, task.stoppageTimes);
    }
