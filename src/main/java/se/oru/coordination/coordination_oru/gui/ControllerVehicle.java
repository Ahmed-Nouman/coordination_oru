...
public class ControllerVehicle {
    ...
    public void changeName() {
        scene.getNameField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changePriority() {
        scene.getPriorityField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeLength() {
        scene.getLengthField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeWidth() {
        scene.getWidthField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeMaxVelocity() {
        scene.getMaxVelocityField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeMaxAcceleration() {
        scene.getMaxAccelerationField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeSafetyDistance() {
        scene.getSafetyDistanceField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeColor() {
        scene.getColorField().setOnAction(e -> {
            var vehicleName = scene.getVehicles().getSelectionModel().getSelectedItem();
            if (vehicleName != null) {
    ...
    public void chooseInitialPose() {
        scene.getInitialPoseField().setOnAction(e -> {
            var vehicleName = scene.getVehicles().getSelectionModel().getSelectedItem();
            if (vehicleName != null) {
    ...
    public void checkIsHuman() {
        scene.getIsHumanField().setOnAction(e -> {
            var vehicleName = scene.getVehicles().getSelectionModel().getSelectedItem();
    ...
    public void changeMissionRepetition() {
        scene.getMissionRepetitionField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void changeLookAhead() {
        scene.getLookAheadDistanceField().focusedProperty().addListener((observable, wasFocused, isNowFocused) -> {
            if (!isNowFocused) {
    ...
    public void clickAddVehicle() {
        scene.getAddVehicle().setOnAction(e -> {
