...
public class AddMissionDialog {
    ...
    private static Optional<MissionStep> dialog(SceneVehicle scene) {
        ...
        dialog.setTitle("Add a mission step");
    ...
    private static Optional<MissionStep> dialogResult(SceneVehicle scene, Dialog<MissionStep> dialog, ButtonType buttonType) {
        ...
        result.ifPresent(missionStep -> scene.getMissions().getItems().add("(" + missionStep.getPoseName() + ", " + missionStep.getDuration() + ")"));
        return result;
    }
