...
public class ThreeRobotsFast {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		tec.setForwardModel(1, new ConstantAcceleration(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getControlPeriod(), tec.getRobotTrackingPeriodInMillis(1)));
		tec.setForwardModel(2, new ConstantAcceleration(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getControlPeriod(), tec.getRobotTrackingPeriodInMillis(2)));
		tec.setForwardModel(3, new ConstantAcceleration(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getControlPeriod(), tec.getRobotTrackingPeriodInMillis(3)));
