...
public class ConstantAcceleration implements ForwardModel {
	...
	public ConstantAcceleration(double maxAccel, double maxVel, double temporalResolution, int controlPeriodInMillis, int trackingPeriodInMillis) {
