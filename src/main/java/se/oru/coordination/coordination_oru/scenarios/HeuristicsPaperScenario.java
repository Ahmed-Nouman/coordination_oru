...
public class HeuristicsPaperScenario {
    ...
    public static final int REPORTING_INTERVAL = 5;
    ...
    public static void main(String[] args) {
        ...
        var scaleAdjustment = MAX_ACCELERATION / mapResolution;
        ...
        productionVehicle2.getPlan(productionVehicle2, YAML_FILE, true);
        productionVehicle3.getPlan(productionVehicle3, YAML_FILE,true);
        productionVehicle4.getPlan(productionVehicle4, YAML_FILE, true);
        productionVehicle5.getPlan(productionVehicle5, YAML_FILE,true);
        productionVehicle6.getPlan(productionVehicle6, YAML_FILE, true);
        productionVehicle7.getPlan(productionVehicle7, YAML_FILE, true);
        productionVehicle8.getPlan(productionVehicle8, YAML_FILE, true);
        serviceVehicle.getPlan(serviceVehicle, YAML_FILE, true);
        //FIXME: The reverse path does not seems to work properly.
