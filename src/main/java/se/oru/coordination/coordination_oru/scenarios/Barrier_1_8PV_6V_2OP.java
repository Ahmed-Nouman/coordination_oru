...
public class Barrier_1_8PV_6V_2OP {
    ...
    public static final String REPORT_ADDRESS = System.getProperty("user.dir") +
            "/src/main/java/se/oru/coordination/coordination_oru/results/Barrier_1_8PV_6SV_2OP/";
...
//        collisionChecker.start();
        ...
        AdaptiveTrackerRK4.scheduleVehiclesStop(s1, tec.trackers.get(s1.getID()), new ArrayList<>(List.of(1, 2)), new ArrayList<>(List.of(2, 4, 6, 8, 10, 12, 14, 16)), trackerRetriever);
        AdaptiveTrackerRK4.scheduleVehiclesStop(s2, tec.trackers.get(s2.getID()), new ArrayList<>(List.of(1, 2)), new ArrayList<>(List.of(2, 4, 6, 8, 10, 12, 14, 16)), trackerRetriever);
