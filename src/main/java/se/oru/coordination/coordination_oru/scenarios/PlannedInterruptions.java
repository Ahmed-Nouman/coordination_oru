...
public class PlannedInterruptions {
    ...
    public static void main(String[] args) throws Exception {
        ...
        explosivesVehicle.addTask(new Task(PLANTING_TIME, new Pose[] {drawPoint34}, false));
        explosivesVehicle.addTask(new Task(PLANTING_TIME, new Pose[] {drawPoint30}, false));
        explosivesVehicle.addTask(new Task(PLANTING_TIME, new Pose[] {entrance}, false));
        ...
        cleaningVehicle.addTask(new Task(CLEANING_TIME, new Pose[] {drawPoint30}, false));
        cleaningVehicle.addTask(new Task(CLEANING_TIME, new Pose[] {drawPoint34}, false));
        cleaningVehicle.addTask(new Task(CLEANING_TIME, new Pose[] {mainTunnelLeft}, false));
        ...
        autonomousVehicle1.addTask(new Task(ORE_LOADING_TIME, new Pose[] {orePass1}, false));
        autonomousVehicle1.addTask(new Task(ORE_UNLOADING_TIME, new Pose[] {drawPoint29}, false));
        ...
        autonomousVehicle2.addTask(new Task(ORE_LOADING_TIME, new Pose[] {orePass2}, false));
        autonomousVehicle2.addTask(new Task(ORE_UNLOADING_TIME, new Pose[] {drawPoint33}, false));
        ...
        autonomousVehicle3.addTask(new Task(ORE_LOADING_TIME, new Pose[] {orePass3}, false));
        autonomousVehicle3.addTask(new Task(ORE_UNLOADING_TIME, new Pose[] {drawPoint12}, false));
