...
public class Barrier_1_4PV_6V_2OP {
    ...
    public static final String REPORT_ADDRESS = System.getProperty("user.dir") +
            "/src/main/java/se/oru/coordination/coordination_oru/results/Barrier_1_4PV_6SV_2OP/";
...
//        collisionChecker.start();
        ...
        AdaptiveTrackerRK4.scheduleVehiclesStop(s5, tec.trackers.get(s5.getID()), new ArrayList<>(List.of(1, 2, 3)), new ArrayList<>(List.of(2, 4, 6, 8)), trackerRetriever);
        AdaptiveTrackerRK4.scheduleVehiclesStop(ht, tec.trackers.get(mt1.getID()), new ArrayList<>(List.of(1, 2, 3, 4, 7, 8, 9, 10)), new ArrayList<>(List.of(2, 4, 6 ,8)), trackerRetriever);
