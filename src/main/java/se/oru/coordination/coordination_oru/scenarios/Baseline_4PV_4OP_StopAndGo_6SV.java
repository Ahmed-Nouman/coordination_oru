...
public class Baseline_4PV_4OP_StopAndGo_6SV {
    ...
    public static final String REPORT_ADDRESS = System.getProperty("user.dir") +
            "/src/main/java/se/oru/coordination/coordination_oru/results/Baseline_4PV_4OP_6SV_StopAndGo_FCFG/";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final var lengthS = 3.0 / SCALE_ADJUSTMENT; //3
        final var widthS = 2.0 / SCALE_ADJUSTMENT; //2

        final var maxVelocityHT = 8.34 / SCALE_ADJUSTMENT;
        final var maxAccelerationHT = 1.0 / SCALE_ADJUSTMENT;
        final var lengthHT = 3.0 / SCALE_ADJUSTMENT; //8
        final var widthHT = 2.0 / SCALE_ADJUSTMENT; //5
