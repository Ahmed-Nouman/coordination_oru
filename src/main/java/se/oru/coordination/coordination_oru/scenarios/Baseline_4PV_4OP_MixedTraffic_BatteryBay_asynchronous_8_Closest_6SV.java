...
public class Baseline_4PV_4OP_MixedTraffic_BatteryBay_asynchronous_8_Closest_6SV {
...
//        mt1.savePlans(CLASS_NAME);
        ...
        lhd2.addTask(new Task("batteryStation6", 8.25, new Pose[] {batteryStation3}, 1));
        lhd2.addTask(new Task("drawPoint6B", 2.25, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation2", 12.0, new Pose[] {batteryStation3}, 1));
        lhd2.addTask(new Task("drawPoint6B", 2.25, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation6", 12.0, new Pose[] {batteryStation3}, 1));
        lhd2.addTask(new Task("drawPoint6B", 2.25, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation2", 12.0, new Pose[] {batteryStation3}, 1));
        lhd2.addTask(new Task("drawPoint6B", 2.25, new Pose[] {drawPoint6B}, 1));
...
//        lhd2.savePlans(CLASS_NAME);
        ...
        mt2.addTask(new Task("oreProduction2", 0.75, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("oreProduction2", 0.75, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("batteryStation", 1.0, new Pose[] {batteryStation4}, 1));
        ...
        mt2.addTask(new Task("oreProduction2", 0, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("oreProduction2", 0, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("batteryStation", 0, new Pose[] {batteryStation4}, 1));
        mt2.addTask(new Task("drawPoint6F", 2.5, new Pose[] {drawPoint6F}, 1));
        mt2.addTask(new Task("oreProduction2", 0, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("oreProduction2", 0, new Pose[] {orePass2, drawPoint6F}, 1));
        mt2.addTask(new Task("oreProduction2", 0, new Pose[] {orePass2, drawPoint6F}, 1));
...
//        mt2.savePlans(CLASS_NAME);
        ...
        lhd3.addTask(new Task("batteryStation7", 0.0, new Pose[] {batteryStation5}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation5}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation5}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation5}, 1));
...
//        lhd3.savePlans(CLASS_NAME);
        ...
        mt3.addTask(new Task("batteryStation", 0, new Pose[] {batteryStation6}, 1));
...
//
        ...
        lhd4.addTask(new Task("batteryStation8", 10.50, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation7}, 1));
