...
public class Baseline_4PV_4OP_MixedTraffic {
...
//        mt1.savePlans(CLASS_NAME);
        ...
        mt2.addTask(new Task("oreProduction2", 0.5, new Pose[] {orePass1}, 10));
...
//        mt2.savePlans(CLASS_NAME);
        ...
        mt3.addTask(new Task("oreProduction3", 0.5, new Pose[] {orePass2}, 10));
...
//        mt3.savePlans(CLASS_NAME);
        ...
        mt4.addTask(new Task("toOrePass2", 0.5, new Pose[] {orePass2}, 10));
