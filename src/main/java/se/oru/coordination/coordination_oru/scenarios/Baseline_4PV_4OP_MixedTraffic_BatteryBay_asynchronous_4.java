...
public class Baseline_4PV_4OP_MixedTraffic_BatteryBay_asynchronous_4 {
    ...
    public static final String REPORT_ADDRESS = System.getProperty("user.dir") +
            "/src/main/java/se/oru/coordination/coordination_oru/results/Baseline_4PV_4OP_MixedTraffic_BatteryBay_asynchronous_4/";
...
//        final Pose batteryStation6 = new Pose(74.35,20.05, -Math.PI/2);
        ...
        lhd1.addTask(new Task("batteryStation5", 12.25, new Pose[] {batteryStation1}, 1));
        lhd1.addTask(new Task("drawPoint4B", 3.5, new Pose[] {drawPoint4B}, 1));
        lhd1.addTask(new Task("batteryStation5", 5.0, new Pose[] {batteryStation1}, 1));
        lhd1.addTask(new Task("drawPoint4B", 3.5, new Pose[] {drawPoint4B}, 1));
        lhd1.addTask(new Task("batteryStation5", 12.5, new Pose[] {batteryStation1}, 1));
        lhd1.addTask(new Task("drawPoint4B", 3.5, new Pose[] {drawPoint4B}, 1));
...
//
        ...
        lhd2.addTask(new Task("batteryStation6", 8.5, new Pose[] {batteryStation1}, 1));
        lhd2.addTask(new Task("drawPoint6B", 3.5, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation2", 15.0, new Pose[] {batteryStation2}, 1));
        lhd2.addTask(new Task("drawPoint6B", 3.5, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation6", 7.5, new Pose[] {batteryStation1}, 1));
        lhd2.addTask(new Task("drawPoint6B", 3.5, new Pose[] {drawPoint6B}, 1));
        lhd2.addTask(new Task("batteryStation2", 15.0, new Pose[] {batteryStation2}, 1));
        lhd2.addTask(new Task("drawPoint6B", 3.5, new Pose[] {drawPoint6B}, 1));
...
//        lhd3.savePlans(CLASS_NAME);
        ...
        mt3.addTask(new Task("batteryStation", 0, new Pose[] {batteryStation8}, 1));
...
//
        ...
        lhd4.addTask(new Task("batteryStation8", 9.60, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 3.5, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 10.0, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 3.5, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 9.60, new Pose[] {batteryStation7}, 1));
        lhd4.addTask(new Task("drawPoint14B", 3.5, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 10.0, new Pose[] {batteryStation1}, 1));
        lhd4.addTask(new Task("drawPoint14B", 3.5, new Pose[] {batteryStation7}, 1));
...
//
        ...
        mt4.addTask(new Task("toOrePass2", 0, new Pose[] {orePass4, drawPoint14F}, 10));
        mt4.addTask(new Task("batteryStation", 0, new Pose[] {batteryStation8}, 1));
