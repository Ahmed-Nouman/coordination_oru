...
public class MixedTraffic_4PV_6SV_4OP_Closest_0DC {
    ...
    public static final String REPORT_ADDRESS = System.getProperty("user.dir") +
            "/src/main/java/se/oru/coordination/coordination_oru/results/MixedTraffic_4PV_6SV_4OP_Closest/";
...
//        s5.savePlans(CLASS_NAME);
        ...
        s5.addTask(new Task("toDrawPoint3", 14.0, new Pose[] {drawPoint3}, 1));
