...
public class ProductionCycleAutonomousMine {
    public static void main(String[] args) throws InterruptedException {
        ...
        var drillVehicle = new AutonomousVehicle(1, Color.MAGENTA, 5, 2, 1000,
                0.5, 0.5, mainTunnelLeft, drillRigGoal, 0);
        var chargingVehicle = new AutonomousVehicle(1, Color.PINK, 5, 2, 1000,
                0.5, 0.5, mainTunnelLeft, chargingVehicleGoal, 0);
        var waterVehicle = new AutonomousVehicle(1, Color.BLUE, 5, 2, 1000,
                0.5, 0.5, mainTunnelLeft, waterVehicleGoal, 0);
