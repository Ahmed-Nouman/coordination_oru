...
public class ProductionCycleAutonomousMine {
    public static void main(String[] args) throws InterruptedException {
        ...
        tec.setForwardModel(autonomousVehicle1.getID(), autonomousVehicle1.getForwardModel());
        tec.setForwardModel(autonomousVehicle2.getID(), autonomousVehicle2.getForwardModel());
