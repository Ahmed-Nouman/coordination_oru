...
public class BatterySynchronousChangeTwoServiceVehicles {
...
//        productionVehicle1.addTask(new Task("", 2.65, new Pose[] {drawPoint4}, 1));
//        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
//        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
...
//                length, width, drawPoint12, safetyDistance, productionGoalRepetition, model);
...
//        productionVehicle2.addTask(new Task("", 2.65, new Pose[] {drawPoint12}, 1));
//        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
//        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
...
//                length, width, drawPoint18, safetyDistance, productionGoalRepetition, model);
...
//        productionVehicle3.addTask(new Task("", 2.70, new Pose[] {drawPoint18}, 1));
//        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
//        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
...
//        serviceVehicle2.loadPlans(PLANS_FOLDER_NAME + "S2(1).path");
        ...
        tec.setDefaultFootprint(serviceVehicle2.getFootprint());
        ...
        String fileName = "FA" + "_" + "C" + "_" + "S" + "_" + serviceVehicle2.getSafetyDistance() * SCALE_ADJUSTMENT + "_"
                + "V" + "_" + serviceVehicle2.getMaxVelocity() * SCALE_ADJUSTMENT + "_";
