...
public class Baseline_4PV_4OP_MixedTraffic_BatteryBay {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final var widthLHD = 8.0 / SCALE_ADJUSTMENT;
        ...
        final Pose batteryStation5 = new Pose(86.55,13.25, Math.PI/2);
...
//        lhd1.addTask(new Task("batteryStation2", 12, new Pose[] {batteryStation2}, 1));
//        lhd1.addTask(new Task("drawPoint4B", 0.5, new Pose[] {drawPoint4F}, 1));
//        lhd1.addTask(new Task("batteryStation2", 12, new Pose[] {batteryStation2}, 1));
//        lhd1.addTask(new Task("drawPoint4B", 0.5, new Pose[] {drawPoint4F}, 1));
//
//        lhd1.generatePlans(planner);
//        lhd1.savePlans(CLASS_NAME);
//        lhd1.loadPlans(PLANS_FOLDER_NAME + "MT-1.path");

        var mt1 = new AutonomousVehicle("MT-1", 1, Color.CYAN, maxVelocityMT, maxAccelerationMT,
                lengthMT, widthMT, drawPoint4F, safetyDistance, 1, model);
        mt1.addTask(new Task("oreProduction1", 1.0, new Pose[] {orePass1, drawPoint4F}, 1));
        mt1.addTask(new Task("oreProduction1", 1.0, new Pose[] {orePass1, drawPoint4F}, 1));
        mt1.addTask(new Task("oreProduction1", 1.0, new Pose[] {orePass1, drawPoint4F}, 1));
        mt1.addTask(new Task("oreProduction1", 1.0, new Pose[] {orePass1, drawPoint4F}, 1));
        mt1.addTask(new Task("oreProduction1", 1.0, new Pose[] {orePass1, drawPoint4F}, 1));
        mt1.addTask(new Task("batteryStation", 1.0, new Pose[] {batteryStation1}, 1));
...
//
        ...
        var mt2 = new AutonomousVehicle("MT-2", 1, Color.CYAN, maxVelocityMT, maxAccelerationMT,
                lengthMT, widthMT, drawPoint6F, safetyDistance, 1, model);
...
//        mt2.savePlans(CLASS_NAME);
        ...
        var mt3 = new AutonomousVehicle("MT-3", 1, Color.CYAN, maxVelocityMT, maxAccelerationMT,
                lengthMT, widthMT, drawPoint12F, safetyDistance, 1, model);
...
//        mt3.savePlans(CLASS_NAME);
        ...
        var mt4 = new AutonomousVehicle("MT-4", 1, Color.CYAN, maxVelocityMT, maxAccelerationMT,
                lengthMT, widthMT, drawPoint14F, safetyDistance, 1, model);
