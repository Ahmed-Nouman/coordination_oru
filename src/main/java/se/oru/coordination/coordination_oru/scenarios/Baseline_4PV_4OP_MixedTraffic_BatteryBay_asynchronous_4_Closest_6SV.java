...
public class Baseline_4PV_4OP_MixedTraffic_BatteryBay_asynchronous_4_Closest_6SV {
...
//        mt2.savePlans(CLASS_NAME);
        ...
        lhd3.addTask(new Task("batteryStation7", 0.0, new Pose[] {batteryStation3}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation3}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation3}, 1));
        lhd3.addTask(new Task("drawPoint12B", 2.25, new Pose[] {drawPoint12B}, 1));
        lhd3.addTask(new Task("batteryStation7", 11.5, new Pose[] {batteryStation3}, 1));
...
//        lhd3.savePlans(CLASS_NAME);
        ...
        mt3.addTask(new Task("batteryStation", 0, new Pose[] {batteryStation4}, 1));
...
//
        ...
        lhd4.addTask(new Task("batteryStation8", 10.50, new Pose[] {batteryStation3}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation3}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation3}, 1));
        lhd4.addTask(new Task("drawPoint14B", 2.25, new Pose[] {drawPoint14B}, 1));
        lhd4.addTask(new Task("batteryStation8", 11.50, new Pose[] {batteryStation3}, 1));
