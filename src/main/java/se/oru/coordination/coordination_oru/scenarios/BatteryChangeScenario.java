...
public class BatteryChangeScenario {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        productionVehicle1.addTask(new Task("", 2.0, new Pose[] {drawPoint4}, 1));
        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
        productionVehicle1.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
...
//        productionVehicle1.savePlans(CLASS_NAME);
        ...
        productionVehicle2.addTask(new Task("", 2.0, new Pose[] {drawPoint12}, 1));
        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
        productionVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
...
//        productionVehicle2.savePlans(CLASS_NAME);
        ...
        productionVehicle3.addTask(new Task("", 2.0, new Pose[] {drawPoint18}, 1));
        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
        productionVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
...
//        productionVehicle3.savePlans(CLASS_NAME);
        ...
        var serviceVehicle1 = new AutonomousVehicle("S1",1, Color.GREEN, 14.0/SCALE_ADJUSTMENT, 1.0/SCALE_ADJUSTMENT,
                length, width, mainTunnelLeft, safetyDistance, 1, model);
        serviceVehicle1.addTask(new Task("", 0.0, new Pose[] {barrier1Entry}, 1));
        serviceVehicle1.addTask(new Task("", 0.0, new Pose[] {drawPoint6}, 1));
        serviceVehicle1.addTask(new Task("", 2.0, new Pose[] {drawPoint13}, 1));
        serviceVehicle1.addTask(new Task("", 2.0, new Pose[] {barrier1Exit}, 1));
...
//        serviceVehicle1.savePlans(CLASS_NAME);
        ...
        var serviceVehicle2 = new AutonomousVehicle("S2",1, Color.GREEN, 14.0/SCALE_ADJUSTMENT, 1.0/SCALE_ADJUSTMENT,
                length, width, drawPoint1, safetyDistance, 1, model);
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {barrier1Entry}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {barrier1Exit}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint1}, 1));
        serviceVehicle2.addTask(new Task("", 32.0, new Pose[] {barrier1Entry}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
        serviceVehicle2.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
...
//        serviceVehicle2.savePlans(CLASS_NAME);
        ...
        var serviceVehicle3 = new AutonomousVehicle("S3",1, Color.GREEN, 7.0/SCALE_ADJUSTMENT, 1.0/SCALE_ADJUSTMENT,
                length, width, mainTunnelRight, safetyDistance, 1, model);
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {barrier2Entry}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint20}, 1)); //
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint19}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint17}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint16}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint15}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass2}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint14}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint13}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint12}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint11}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint10}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint9}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint8}, 1)); //
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint7}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint6}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass1}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint5}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint4}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint3}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {barrier2Exit}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {mainTunnelRight}, 1));
        serviceVehicle3.addTask(new Task("", 40.0, new Pose[] {barrier2Entry}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint20}, 1)); //
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {orePass3}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint19}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {drawPoint18}, 1));
        ...
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {barrier2Exit}, 1));
        serviceVehicle3.addTask(new Task("", 0.0, new Pose[] {mainTunnelRight}, 1));
//        serviceVehicle3.generatePlans(planner);
//        serviceVehicle3.savePlans(CLASS_NAME);
        serviceVehicle3.loadPlans(PLANS_FOLDER_NAME + "S3.path");
